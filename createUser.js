...
function sendVerificationEmail(email, token, fn) {
    var subject = 'Email for ' + config.EXTERNAL_NAME;
        ...
        Message:{
            ...
            Body:{
                Html:{
                    ...
                    + '<title>' + subject + '/title>'
                    + '</head><Body>'
                    + 'Please <a href="' + verificationLink + '">click here to verify your email address</a> or copy and '
                    + 'paste the following link in a browser:'
                    + '<br><br>'
